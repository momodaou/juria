...
- **Corrections de l'audit appliquées le 17/08/2026 (priorités 1 à 3 sur 5, avec l'accord de l'utilisateur)** :
  ...
  - Non fait (priorités 4-5, au rythme du projet) : helmet, filtrage de type sur les téléversements, IP publique Cloud SQL toujours activée, CI/CD, tests automatisés.
