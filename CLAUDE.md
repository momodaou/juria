...
- Modules restant à développer (backend + écrans) : Atelier d'actes, Bibliothèque, Plan d'action, Dépenses & caisse, Rétrocessions, Accès & permissions, Cabinet (RH), Assistant IA, Portail client. Voir `APP/README.md` § 5-6.
