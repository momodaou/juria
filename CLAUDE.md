...
- Modules restant à développer (backend + écrans) : Plan d'action, Dépenses & caisse, Rétrocessions, Accès & permissions, Cabinet (RH), Assistant IA (écran dédié), Portail client. Voir `APP/README.md` § 5-6.
