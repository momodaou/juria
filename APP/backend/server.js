...
app.use("/api/parametres", authenticate, require("./src/routes/parametres"));
...
// Points d'entrée internes pour Cloud Scheduler (jobs planifiés) — hors
// authenticate standard, protégés par secret partagé. Voir
// src/routes/internal-jobs.js.
app.use("/internal/jobs", require("./src/routes/internal-jobs"));
