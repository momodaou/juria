...
**Déploiement production** : à faire (rebuild + redeploy des deux services Cloud Run, même procédure que la veille) — pas de nouvelle migration de schéma nécessaire (aucun changement de structure, juste du code retiré).
