...
**Déploiement production** : pas encore fait à ce stade — nécessite la migration `client_pieces_kyc.type_mime` (nouvelle, contrairement aux changements précédents de la session) en plus du redéploiement des deux services.
